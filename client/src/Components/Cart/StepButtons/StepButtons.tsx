...
function StepButtons() {
    ...
    return(
        <div className={classes.stepButtonsWrapper} style={{justifyContent: justifyContent}}>
            ...
            {cartConfirm && location.pathname.includes('checkout') && <NavLink onClick={handleClearCart} to={'/products'} className={`${classes.stepButton} prevButton`}>Back To Products</NavLink> }
